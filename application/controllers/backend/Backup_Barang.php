...
class Barang extends CI_Controller
{
	...
	{
		/* SELECT DATA ALL */
		$this->db->select("*,(SELECT model FROM ms_barang_model WHERE id = table1.id_model) AS model
							,(SELECT merk FROM ms_barang_merk WHERE id = table1.id_merk) AS merk");
	...
	public function form()
	{
		...
		$data_content['size']  = $size;
		$data_content['model']  = $model;
		$data_content['merk']  = $merk;
	...
	public function form_edit($param)
	{
		...
		$query = $this->db->query("SELECT *,
										(SELECT model FROM ms_barang_model WHERE id = table1.id_model) AS model,
										(SELECT merk FROM ms_barang_merk WHERE id = table1.id_merk) AS merk 
