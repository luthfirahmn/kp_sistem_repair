...
class Karyawan extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Karyawan';
		$data_content['breadcrumb']   = 'Karyawan';
		$data_content['breadcrumb1']  = 'Karyawan List';


		$config["js"] = 'karyawan/index';
		$config["content_file"] = "karyawan/index";
	...
	public function form()
	{
		...
		$data_content['title']        = 'Karyawan';
		$data_content['breadcrumb']   = 'Karyawan';
		$data_content['breadcrumb1']  = 'Karyawan Form';
		$data_content['status_form']  = 0;
		$data_content['posisi']  = $posisi;

		$config["content_file"] = "karyawan/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Karyawan';
		$data_content['breadcrumb']   = 'Karyawan';
		$data_content['breadcrumb1']  = 'Karyawan Form Edit';
