...
class Model extends CI_Controller
{
	...
	public function index()
	{
		...
		$data_content                 = array();
		$data_content['title']        = 'Model';
		$data_content['breadcrumb']   = 'Model';
		$data_content['breadcrumb1']  = 'Model List';


		$config["js"] = 'model/index';
		$config["content_file"] = "model/index";
	...
	public function form()
	{
		...
		$data_content['title']        = 'Model';
		$data_content['breadcrumb']   = 'Model';
		$data_content['breadcrumb1']  = 'Model Form';
		$data_content['status_form']  = 0;

		$config["content_file"] = "model/form";
		$config["content_data"] = $data_content;
	...
	public function form_edit($param)
	{
		...
		$data_content['title']        = 'Model';
		$data_content['breadcrumb']   = 'Model';
		$data_content['breadcrumb1']  = 'Model Form Edit';
